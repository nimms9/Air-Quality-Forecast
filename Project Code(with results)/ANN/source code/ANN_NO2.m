...
M = csvread('C:\Users\ravip\Desktop\Project Code\ANN\input\Standard_Input(Training).csv');
...
test = csvread('C:\Users\ravip\Desktop\Project Code\ANN\input\Standard_Input(Testing).csv');
test1 = test';
