train_x=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_training.xlsx','D2:P3288');
train_y_NO2=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_training.xlsx','Q2:Q3288');
train_y_O3=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_training.xlsx','R2:R3288');
train_data_NO2=[train_x train_y_NO2];
train_data_O3=[train_x train_y_O3];

valid_x=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_validation.xlsx','D2:P1095');
valid_y_NO2=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_validation.xlsx','Q2:Q1095');
valid_y_O3=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_validation.xlsx','R2:R1095');
valid_data_NO2=[valid_x valid_y_NO2];
valid_data_O3=[valid_x valid_y_O3];

test_x=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_test.xlsx','D2:P1003');
test_y_NO2=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_test.xlsx','Q2:Q1003');
test_y_O3=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_test.xlsx','R2:R1003');
test_data_NO2=[test_x test_y_NO2];
test_data_O3=[test_x test_y_O3];

train_time=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_training.xlsx','C2:C3288');
valid_time=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_validation.xlsx','C2:C1095');
test_time=xlsread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\ANFIS\input\standardized_test.xlsx','C2:C1003');
...
%  writefis(initialfis_NO2,'C:\Users\Lenovo\Documents\MATLAB\initialfis_NO2.fis');
 writefis(outfis_NO2_5,'C:\Users\Lenovo\Documents\MATLAB\outfis_NO2_5.fis');
 writefis(outfis_NO2,'C:\Users\Lenovo\Documents\MATLAB\outfis_NO2.fis');
 %  writefis(chkfis_10,'C:\Users\Lenovo\Documents\MATLAB\chkfis_10.fis');
% showrule(outfis_NO_10);
% writefis(initialfis_O3,'C:\Users\Lenovo\Documents\MATLAB\initialfis_O3.fis');
writefis(outfis_O3_5,'C:\Users\Lenovo\Documents\MATLAB\outfis_O3_5.fis');
writefis(outfis_O3,'C:\Users\Lenovo\Documents\MATLAB\outfis_O3.fis');
% writefis(chkfis_O3,'C:\Users\Lenovo\Documents\MATLAB\chkfis_O3.fis');
...
NO2_content=evalfis([std_ben std_bp std_co std_mpxy std_no std_no2 std_o3 std_rh std_so2 std_temp std_tol std_wd std_ws],outfis_NO2_5);
actual_NO2=NO2_content*(1.82236367e+03)+62.50785584;
O3_content=evalfis([std_ben std_bp std_co std_mpxy std_no std_no2 std_o3 std_rh std_so2 std_temp std_tol std_wd std_ws],outfis_O3_5);
...
% writefis(outfis_NO_10,'C:\Users\Lenovo\Documents\MATLAB\outfis_NO_10.fis');
% 
