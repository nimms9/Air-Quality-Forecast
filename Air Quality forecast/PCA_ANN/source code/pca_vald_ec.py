# Program to reduce variables into PCs for validation data.

import numpy as np
import pandas as pd
import csv

# reading validation data into list
data = []
with open('val_inp.csv', 'r') as csvfile:
...
np.savetxt("pca_inp_val_NO2_ec.csv", new1, delimiter=",")
np.savetxt("pca_inp_val_O3_ec.csv", new2, delimiter=",")
