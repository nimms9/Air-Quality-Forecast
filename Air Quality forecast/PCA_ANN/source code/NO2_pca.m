...
M = csvread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\PCA_ANN\input\pca_inp_NO2_ec.csv');
...
test = csvread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\PCA_ANN\output\pca_inp_test_NO2_ec.csv');
test1 = test(:,1:9)';
...
E = csvread('C:\Users\Lenovo\Downloads\Compressed\AI_Project-master\PCA_ANN\output\eign_vec_ec.csv');
l = size(E);
A = zeros(1,l(2));
for m = 1:l(2)
    A(1,m) = dot(E(:,m),k);
